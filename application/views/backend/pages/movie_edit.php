	        ...
	        <div class="panel panel-primary">
	            ...
	            <div class="panel-body">
	                ...
	                <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                        	...
                        	?>
								...
								<input type="text" name="duration" class="form-control timepicker" data-template="dropdown" value="<?php echo $hours . ':' . $minutes . ':' . $seconds; ?>" data-show-seconds="true" data-show-meridian="false" data-minute-step="1" data-second-step="1" placeholder="Hora : Minutos : Segundos" />
					...
					<div class="form-group mb-3">
						...
						<span class="help">- Estrellas obtenidas de calificación</span>
					...
					<div class="row mt-3">
			        	<div class="col-md-6 text-center">
							<input type="submit" class="btn btn-success w-100" value="Editar pelicula">
			        	</div>
			        	<div class="col-md-6 text-center">
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<?php else :?>
						...
						<?php else: ?>
							<h4><?php get_phrase('URL del video no soportada'); ?></h4>
						<?php endif; ?>
						</video>
