...
<div class="container">
	<div class="row justify-content-center mb-5">
		<div class="col-md-8">
			<div class="row">
				<div class="col-md-12">
					<span class="payment-header-text float-left"><b><?php echo get_phrase('Realizar pago'); ?></b></span>
	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="row">
				...
				<div class="col-md-8">
					<div class="w-100">
						<p class="pb-2 payment-header"><?php echo get_phrase('Pagos'); ?> <?php echo get_phrase('Resúmen'); ?></p>
					...
					<div class="w-100 float-left">
						<form action="<?php echo base_url('index.php?payment/paypal_checkout'); ?>" method="post" class="paypal-form form">
							...
							<button type="submit" class="payment-button float-right"><?php echo get_phrase('Pagar con Paypal'); ?></button>
						</form>
						<form action="<?php echo base_url('index.php?payment/stripe_checkout'); ?>" method="post" class="stripe-form form">
							<hr class="border mb-4">
							<input type="hidden" name="plan_id" value="<?php echo $plan_details['plan_id']; ?>">
							<button type="submit" class="payment-button float-right"><?php echo get_phrase('Pagar con Stripe'); ?></button>
						</form>
						...
						<?php if(addon_status('paytm') == 1): ?>
							<form action="<?php echo base_url('index.php?addons/paytm/paytm_checkout'); ?>" method="post" class="paytm-form form">
								<hr class="border mb-4">
								<input type="hidden" name="plan_id" value="<?php echo $plan_details['plan_id']; ?>">
								<button type="submit" class="payment-button float-right"><?php echo get_phrase('Pagar con Paytm'); ?></button>
							</form>
						<?php endif; ?>
					</div>
				</div>
