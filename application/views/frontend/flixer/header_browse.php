		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				...
				<?php if($this->session->userdata('active_user') != 'admin'): ?>
					<li>
						<a href="<?php echo base_url();?>index.php?browse/mylist"><?php echo get_phrase('Mi lista');?></a>
					</li>
				<?php endif;	 ?>

				<?php if(addon_status('blog')): ?>
					<li class="<?php if($page_name == 'blogs') echo 'active'; ?>">
						<a class="" href="<?php echo base_url();?>index.php?addons/blog"><?php echo get_phrase('Comunidad web');?></a>
					</li>
				<?php endif; ?>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="themes">
						...
						<?php endif;?>
						<li class="divider"></li>
						<li><a href="<?php echo base_url();?>index.php?browse/manageprofile"><?php echo get_phrase('Editar Perfiles');?></a></li>
						<li class="divider"></li>
						<!-- SHOW ADMIN LINK IF ADMIN LOGGED IN -->
						<?php
							if($this->session->userdata('login_type') == 1):
								?>
						<li><a href="<?php echo base_url();?>index.php?admin/dashboard"><?php echo get_phrase('Administrador');?></a></li>
						<?php endif;?>
						<li><a href="<?php echo base_url();?>index.php?browse/youraccount"><?php echo get_phrase('Cuenta');?></a></li>
						<li><a href="<?php echo base_url();?>index.php?home/signout"><?php echo get_phrase('Cerrar sesión');?></a></li>
					</ul>
				</li>
			</ul>
			<!-- SEARCH FORM -->
